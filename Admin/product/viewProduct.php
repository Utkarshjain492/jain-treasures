...
<?php
    ...
    if(empty($products)){
        ...
        echo '<h1 style="color: #fff; background-color: #333; position: relative; left: 25%; top: 200px; width: fit-content; padding: 40px; font-size: 40px; border: 1px solid #ddd; box-shadow: 0 0 10px rgba(0, 0, 0, 1);">You did not added any Product yet</h1>';
        exit;
    ...
    while($dbrow = mysqli_fetch_assoc($sql_result)){
        echo "<div class='card'>
                ...
                <img src='$dbrow[imgpath]' alt='image'>
            </div>
